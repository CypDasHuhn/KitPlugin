...
public class KitEditInventoryCommand extends SkeletonCommand {
    public static final String KIT_EDIT_INVENTORY_COMMAND = "inventory";
    ...
    public void command(CommandSender sender, String[] args, String label) {
        ...
        KitAction.updateKitInventory(player, kit);
    }
